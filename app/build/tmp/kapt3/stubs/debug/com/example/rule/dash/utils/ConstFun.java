...
public final class ConstFun {
    ...
    com.example.rule.dash.ui.widget.toolbar.CustomToolbar toolbar, boolean state) {
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.lang.String listToStringChild(@org.jetbrains.annotations.NotNull()
    java.util.List<com.example.rule.dash.data.model.Child> list) {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.example.rule.dash.data.model.Child> stringToListChild(@org.jetbrains.annotations.NotNull()
